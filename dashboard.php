...
<html>
<head>
<title>RESERVEiT | Admin Dashboard</title>
		...
		<div id="page-wrapper" class="row calender widget-shadow">
			<div class="main-page">
				...
				<div class="row calender widget-shadow">
					...
					<?php $query5=mysqli_query($con,"Select * from  tblappointment where AptDate = 'Y-m-d'");
$todayapt=mysqli_num_rows($query5);
?>
...
?>
					...
					<div class="col-md-4 widget states-last">
						<?php $query3=mysqli_query($con,"Select * from tblappointment where Status='Approved'");
...
?>
				...
				<div class="row calender widget-shadow">
					...
					<div class="col-md-4 widget">
						<?php $query4=mysqli_query($con,"Select * from tblappointment where Status='Cancelled'");
